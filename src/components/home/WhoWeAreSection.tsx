...
export function WhoWeAreSection() {
  ...
  return (
    <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.8 }} className="bg-white relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 pt-16 pb-14 sm:px-6 lg:px-12 lg:pt-20 lg:pb-16">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-24">
          ...
          >
            ...
            <motion.h2 className="text-3xl sm:text-[2.75rem] leading-[1.2] lg:leading-[1.1] font-medium text-gray-900 mb-6 lg:mb-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 1.2, ease: [0, 0, 0.2, 1] }}
            className="mt-4 flex w-full flex-col items-center gap-10 text-center lg:mt-0 lg:w-1/2 lg:items-start lg:justify-center lg:gap-12 lg:pl-10 lg:text-left"
          >
            {/* Stat 1 */}
      ...
      <div className="relative h-[180px] w-full sm:h-[220px] lg:h-[280px]">
        {/* Background Image */}
        <div
        ...
        {/* Tabs Container */}
        <div className="container absolute right-0 bottom-0 left-0 z-20 mx-auto flex items-end justify-center px-3 sm:gap-2 sm:px-4">

          {/* Previous Arrow */}
          <button
            onClick={handlePrevTab}
            className="flex h-[88px] w-9 shrink-0 cursor-pointer flex-col items-center justify-center text-gray-500 transition-all duration-300 hover:bg-white/50 hover:text-red-500 sm:h-[120px] sm:w-12"
          ...
          <div className="no-scrollbar flex w-full items-stretch justify-start overflow-x-auto overflow-y-hidden bg-transparent px-1 snap-x snap-mandatory sm:max-w-3xl sm:justify-around sm:px-0">
            {tabs.map((tab) => {
              ...
              return (
                <div
                  ...
                  className={`flex h-full min-h-[88px] w-[128px] shrink-0 snap-center cursor-pointer flex-col items-center justify-center px-2 text-center transition-all duration-300 sm:min-h-[120px] sm:w-[200px]
                    ${isActive
                ...
                >
                  <div className={`mb-2 flex h-10 w-10 items-center justify-center text-[#ef4444] transition-transform duration-300 sm:mb-3 ${isActive ? 'scale-100' : 'scale-90 opacity-70'}`}>
                    {tab.icon}
                  </div>
                  <span className={`line-clamp-2 text-[10px] font-bold uppercase tracking-[0.18em] transition-colors duration-300 sm:text-xs sm:tracking-widest ${isActive ? 'text-gray-900' : 'text-gray-600'}`}>
                    {tab.title}
                  </span>
                </div>
              );
      ...
      {/* Tab Content Area */}
      <div className="min-h-[320px] bg-white sm:min-h-[400px]">
        {/* Team Tab (id: 0) */}
        {activeTab === 0 && (
          <motion.div
            ...
            className="container mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 py-14 sm:px-6 lg:flex-row lg:gap-20 lg:px-12 lg:py-24"
          >
            {/* Left Image Area */}
            <div className="group relative h-[280px] w-full overflow-hidden rounded-xl shadow-2xl shadow-gray-200 sm:h-[450px] lg:w-1/2">
              <motion.div
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              <motion.h2 className="text-3xl sm:text-[2.5rem] font-bold text-[#0a102f] mb-6">
                Our Team
              </motion.h2>
        ...
        {activeTab === 1 && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="container mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-12 lg:py-24"
          >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
              {[
                ...
                <div key={idx} className="flex flex-col items-center rounded-xl border border-gray-100 bg-gray-50 p-6 text-center transition-all hover:-translate-y-1 hover:shadow-lg sm:p-8">
                  ...
                  <motion.h2 className="text-xl font-bold text-gray-900">{item.title}</motion.h2>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        {activeTab === 2 && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="container mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-12 lg:py-24"
          >
            <div className="text-center mb-12">
              <motion.h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-10">
              {/* Vision */}
              <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg sm:p-8">
                ...
                <motion.h2 className="mb-4 flex items-center gap-3 text-xl font-bold text-gray-900 sm:text-2xl">
                ...
                <p className="text-base font-medium leading-relaxed text-gray-600 sm:text-lg">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg sm:p-8">
                ...
                <motion.h2 className="mb-4 flex items-center gap-3 text-xl font-bold text-gray-900 sm:text-2xl">
                  <span className="text-red-500">
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5h2.75z" /></svg>
                  </span>
                  Mission
                </motion.h2>
                <p className="text-base font-medium leading-relaxed text-gray-600 sm:text-lg">
