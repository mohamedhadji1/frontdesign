...
export function AboutClient() {
  ...
  return (
    <main className="min-h-screen bg-white overflow-hidden">
      ...
      <section id="mission" className="relative w-full py-24 flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            <motion.h2 
              ...
              viewport={{ once: true }}
              transition={{ duration: 1 }}
              className="text-4xl lg:text-5xl font-bold text-zinc-900 uppercase tracking-tighter text-zinc-950">Our Commitment</motion.h2>
          </motion.div>
