...
export function OurLeaderSection() {
  return (
    <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.8 }} className="bg-black py-10 relative overflow-hidden" style={{ fontFamily: "'Gotham', sans-serif" }}>
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl relative z-10">
        <motion.h2 className="text-[#FF1111] font-bold tracking-[0.25em] mb-12 uppercase text-sm md:text-base">
          Our Leader
        </motion.h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          ...
          <div className="w-full lg:flex-1 flex flex-col justify-center text-white mt-4">
            <motion.h2 className="text-3xl lg:text-[32px] font-bold mb-3 tracking-wide">
            </motion.h2>
