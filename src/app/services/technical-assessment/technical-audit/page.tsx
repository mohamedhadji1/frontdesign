...
const offerings = [
  {
    ...
    href: "/services/technical-assessment/infrastructure-assessment",
  },
  {
  ...
  },
  {
    ...
    href: "/services/technical-assessment/architecture-assessment",
  },
  {
    ...
    features: ["Group policy assessment", "Access control"],
    href: "/services/technical-assessment/active-directory-assessment",
  },
  {
    ...
    href: "/services/technical-assessment/technical-assistance",
  },
  {
  ...
  },
  {
    ...
    href: "/services/technical-assessment/network-security-architecture",
  },
  {
    title: "Application Security Support",
    desc: "Ensuring application layer security by assessing code, implementing a secure software development lifecycle (SSDLC), and training teams.",
    icon: <Lock className="w-8 h-8" />,
    threats: ["Injection flaws", "Authentication bypasses"],
    features: ["Secure SSDLC support", "Developer awareness"],
    href: "/services/technical-assessment/application-security-support",
  },
];
...
export default function TechnicalAssessmentOverviewPage() {
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.8 }} className="relative bg-zinc-950 min-h-[100svh] flex flex-col justify-center pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <HeroTypeLine
              items={["Critical configuration assessments", "Systems hardening guides", "SWIFT & PCI-DSS compliance assessments"]}
            />

            <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-2xl">
              Outsourcing technical assessment and assistance with Keystone ensures full compliance, rigorous configuration monitoring, and prompt remediation of your infrastructure flaws.
            </p>
