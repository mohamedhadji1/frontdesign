...
const steps = [
  ...
  {
    id: "followup",
    title: "Post-Assessment Follow-up and Support",
    description: "We provide post-assessment follow-up to help you implement recommendations and continuously improve security.",
