...
const steps = [
  {
    ...
    description: "We evaluate applications to identify vulnerabilities and potential flaws.",
    icon: <Network className="w-8 h-8 text-white" />
  },
  {
    id: "measures",
    title: "Implementation of Security Measures",
    description: "We implement adapted security measures, such as strong authentication, access management, etc.",
    icon: <Settings className="w-8 h-8 text-white" />
  },
  {
    id: "testing",
    title: "Security Testing and Assessments",
    description: "We perform security tests to identify weaknesses and potential attack entry points.",
    icon: <ShieldAlert className="w-8 h-8 text-white" />
  },
  {
    id: "training",
    title: "Training and Awareness",
    description: "We offer awareness sessions for teams to reinforce good security practices.",
    icon: <CheckCircle className="w-8 h-8 text-white" />
  },
  {
    id: "maintenance",
    title: "Monitoring and Maintenance",
    description: "We provide regular monitoring and maintenance to guarantee the sustainability of security measures.",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm font-semibold tracking-wide uppercase">
                  ...
                  <span className="text-red-500/30 flex flex-nowrap shrink-0">/</span>
                  <span className="text-white/90">Application Security Support</span>
                </div>
              </motion.div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                Application <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">Security</span>
              </h1>
              ...
              <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-xl">
                Keystone offers customized support to enhance the security of your existing applications or those under development.
              </p>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm p-4">
                <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=1200&auto=format&fit=crop" alt="Application Security" className="rounded-xl w-full object-cover h-[350px]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16 text-center mx-auto">
            ...
            <p className="text-zinc-600 text-lg">
              We integrate automated security gates into your CI/CD pipelines, train your developers, and assessment your critical APIs for flawless impermeability.
            </p>
          </div>
          ...
          <div className="mt-16 max-w-4xl mx-auto p-8 bg-zinc-950 text-white rounded-2xl border border-zinc-800 text-center">
            <h3 className="text-2xl font-bold mb-3">Keystone: Your Partner in Application Security</h3>
            <p className="text-zinc-400 text-sm max-w-2xl mx-auto leading-relaxed mb-6">
              Keystone supports you in securing your applications against cyber threats. Contact us for support tailored to your specific needs.
            </p>
