...
const steps = [
  ...
  {
    id: "reporting",
    title: "Detailed Assessment Report and Practical Solutions",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-xl">
                Keystone offers a complete assessment of industrial systems to guarantee their security, resilience, and alignment with industry standards.
              </p>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm p-4">
                <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200&auto=format&fit=crop" alt="Industrial Assessment" className="rounded-xl w-full object-cover h-[350px]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16 max-w-4xl mx-auto p-8 bg-zinc-950 text-white rounded-2xl border border-zinc-800 text-center">
            ...
            <p className="text-zinc-400 text-sm max-w-2xl mx-auto leading-relaxed mb-6">
              Keystone supports you in assessing and securing your industrial systems. Contact us for an in-depth evaluation and solutions tailored to your industry.
            </p>
