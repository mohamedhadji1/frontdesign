...
const offerings = [
  {
    ...
    desc: "In-depth evaluation of computer systems, evaluating configurations, robustness, and posture security to identify weaknesses.",
    icon: <Server className="w-8 h-8" />,
    threats: ["Configuration Flaws", "Outdated Patches"],
    features: ["System Review", "Vulnerability ID"],
    href: "/services/technical-assessment/technical-assessment",
  },
  {
  ...
  {
    title: "Industrial System Assessment",
