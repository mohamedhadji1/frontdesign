...
const steps = [
  {
    ...
    description: "We review your entire infrastructure, assessing the robustness, configuration, and security of networks, servers, and systems.",
    icon: <Network className="w-8 h-8 text-white" />
  },
  {
    id: "vulnerability",
    title: "Vulnerabilities and Risks Identification",
    description: "We detect potential flaws, vulnerabilities, and security risks that could compromise your infrastructure.",
    icon: <ShieldAlert className="w-8 h-8 text-white" />
  },
  {
    id: "compliance",
    title: "Compliance with Standards and Regulations",
    description: "We verify compliance with current security standards and regulations to ensure an optimal security posture.",
    icon: <CheckCircle className="w-8 h-8 text-white" />
  },
  {
    id: "reporting",
    title: "Detailed Report and Strategic Recommendations",
    description: "We provide a detailed report of our findings, along with strategic recommendations to improve security and performance.",
    icon: <FileText className="w-8 h-8 text-white" />
  },
  {
    id: "support",
    title: "Post-Assessment Follow-up and Continuous Support",
    description: "We support you in implementing recommendations and offer continuous support to maintain security and performance.",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm font-semibold tracking-wide uppercase">
                  ...
                  <span className="text-red-500/30 flex flex-nowrap shrink-0">/</span>
                  <span className="text-white/90">Infrastructure Assessment</span>
                </div>
              </motion.div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                Infrastructure <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">Assessment</span>
              </h1>
              ...
              <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-xl">
                Keystone conducts in-depth assessments of IT infrastructures to guarantee their security, efficiency, and compliance.
              </p>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm p-4">
                <img src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1200&auto=format&fit=crop" alt="Infrastructure Assessment" className="rounded-xl w-full object-cover h-[350px]" />
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.8 }} className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16 max-w-4xl mx-auto p-8 bg-zinc-950 text-white rounded-2xl border border-zinc-800 text-center">
            <h3 className="text-2xl font-bold mb-3">Keystone: Your Partner in IT Security</h3>
            <p className="text-zinc-400 text-sm max-w-2xl mx-auto leading-relaxed mb-6">
              Keystone offers its expertise to assessment and secure your IT infrastructures. Contact us for a complete evaluation and tailored solutions.
            </p>
