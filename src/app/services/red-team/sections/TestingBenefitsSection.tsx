          ...
          {benefits.map((item, idx) => (
            ...
            >
              <button
                ...
                className={`group w-full text-left p-5 rounded-lg border transition-all duration-300 flex items-start gap-4 ${activeIdx === idx
              ...
              >
                <div className={`mt-0.5 p-2 rounded-md transition-colors shrink-0 ${activeIdx === idx ? "bg-red-50 text-red-600" : "bg-zinc-100 text-zinc-400 group-hover:text-red-500 group-hover:bg-red-50/50"
                  }`}>
                  {item.icon}
                </div>
                <div className="flex-1">
                  <h4 className={`text-lg font-bold mb-1 transition-colors ${activeIdx === idx ? "text-zinc-900" : "text-zinc-500 group-hover:text-zinc-800"
                    }`}>
                    {item.title}
                  </h4>
                  <AnimatePresence>
                ...
                <div className={`mt-1 shrink-0 transition-all duration-300 ${activeIdx === idx
