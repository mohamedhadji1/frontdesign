...
const features = [
  {
    title: "AD Security Analysis",
    description:
      "We evaluate the security of configurations, access strategies, and security controls within the Active Directory.",
    icon: Network,
  },
  {
    title: "Compliance with Best Practices",
    description:
      "We verify compliance with identity and access management best practices for secure and efficient use.",
    icon: CheckCircle2,
  },
  {
    title: "Risks Identification",
    description:
      "We identify potential risks (protocol vulnerabilities, ACL misconfigurations, doubtful trust relationships) and propose recommendations to strengthen security and optimize access management.",
    icon: ShieldAlert,
  },
];
...
const subFeatures = [
  {
    title: "Detailed Reporting & Recovery",
    description:
      "We provide a comprehensive report including specific, actionable corrective actions to improve the security and performance of the AD.",
    icon: FileText,
  },
  {
    title: "Identity Security Expertise",
    description:
      "An effective Active Directory assessment significantly strengthens system resistance against credential dumping, privilege escalations, and lateral movements.",
    icon: Zap,
  },
];

export default function ActiveDirectoryAssessmentPage() {
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">AD Infrastructure Assessment</span>
            </div>
            ...
            <HeroTypeLine
              items={["IAM & GPO securing", "Eradication of lateral attack paths", "AD configuration assessment"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone conducts in-depth assessments of Active Directory infrastructures to guarantee their security, performance, and compliance, blocking attacker progression in your Windows domain.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request AD Assessment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="IDENTITY HYGIENE" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              We analyze Group Policies (GPO), AD object ACLs, and privilege delegations to block an attacker's progression in your Windows domain.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="AD HYGIENE STANDARDS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Expose Directory Exposure
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR SECURE IDENTITY GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Identity Security Expert
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone is ready to collaborate with you to conduct thorough assessments of your authorizations, Group Policies, and Active Directory architecture. Contact us to build a robust, lateral-movement-resistant domain security strategy.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Comprehensive AD Configuration, Domain Controller, and GPO Securing Reviews",
                  "Eradication of Lateral Attack Paths, Kerberoasting, and Over-Privilege Risk Points",
                  "Actionable Remediation Strategy for Secure Identity and Access Control Hygiene",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Eradicate lateral attack paths in your Windows domain. Reach out to our Active Directory assessment specialists today to perform a precise configuration and GPO security check."
                </p>
