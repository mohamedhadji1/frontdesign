...
const features = [
  {
    title: "Networks and Systems Analysis",
    description:
      "We review your entire infrastructure, assessing the robustness, configuration, and security of networks, servers, and active systems.",
    icon: Network,
  },
  {
    title: "Vulnerabilities and Risks Identification",
    description:
      "We detect potential flaws, misconfigurations, and key security risks that could compromise your corporate network infrastructure.",
    icon: ShieldAlert,
  },
  {
    title: "Compliance with Standards & Regulations",
    description:
      "We verify compliance with current security standards, CIS controls, and regulations to ensure an optimal and hardened security posture.",
    icon: CheckCircle2,
  },
];
...
const subFeatures = [
  {
    title: "Detailed Report & Strategic Recommendations",
    description:
      "We provide a comprehensive technical report of our findings, along with prioritized recommendations to improve infrastructure security and resilience.",
    icon: FileText,
  },
  {
    title: "Post-Assessment Support",
    description:
      "We support your IT teams in implementing recommendations and offer continuous advice to maintain reliable security and optimal performance.",
    icon: Settings,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Infrastructure Assessment</span>
            </div>
            ...
            <HeroTypeLine
              items={["Comprehensive evaluation", "Network & server configuration validation", "Proactive resilience assurance"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone conducts in-depth assessments of IT infrastructures to guarantee their security, efficiency, and compliance under any load.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Infrastructure Assessment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="EVALUATION METHODOLOGY" className="mb-10" />
            <motion.h2
            ...
            >
              Verify Infrastructure Robustness
            </motion.h2>
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              A comprehensive technical framework designed to evaluate network security, verify configurations, and reduce risk surfaces.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="INFRASTRUCTURE HYGIENE" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR SECURE INFRASTRUCTURE GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Partner in IT Security
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone offers its advanced technical expertise to evaluate, secure, and continuously harden your IT infrastructures. Contact us for detailed topology assessments, server audits, and custom remediation solutions.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Audit of Networks, Hypervisors, Storage and Active Directory Inlets",
                  "Vulnerability Identification with Hand-Verified Proofs-of-Concepts (PoCs)",
                  "Practical Remediation Roadmap Tailored to Your Specific System Context and Flow Goals",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Expose weaknesses before adversaries exploit them. Reach out to our infrastructure assessment specialists today to perform a precise configuration and network security check."
                </p>
