...
const features = [
  {
    ...
    description:
      "Our team intervenes immediately to efficiently resolve complex technical problems, minimizing interruptions and malfunctions.",
    icon: Settings,
  },
  {
    title: "Implementation of Solutions",
    description:
      "We implement adapted configurations and system upgrades to optimize performance and meet the specific needs of your organization.",
    icon: Activity,
  },
  {
    title: "Monitoring and Maintenance",
    description:
      "We provide regular monitoring and proactive maintenance to guarantee the long-term stability and reliability of your system defenses.",
    icon: ShieldAlert,
  },
];
...
const subFeatures = [
  {
    ...
    description:
      "Our team of senior security engineers remains available to respond quickly to your emergency requests and resolve active operational issues.",
    icon: CheckCircle2,
  },
  {
    title: "Advice and Expertise",
    description:
      "We offer ongoing expert advice to optimize your security architectures, hardening postures, and overall operational efficiency.",
    icon: FileText,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Technical Assistance</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone offers specialized technical support from senior experts to quickly troubleshoot problems, guarantee proper functioning, and optimize your infrastructures.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Support Assistance <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="ASSISTANCE & SUPPORT" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              Continuous support from senior engineers for hardening, regular assessing of your networks, and proactive securing of your strategic applications.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="SENIOR EXPERTISE" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Continuous Engineering Accompaniment
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR TECHNICAL SERENITY GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Reliable Technical Partner
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports your organization with highly responsive and senior technical support to maintain, optimize, and secure your systems. Contact us for troubleshooting, hardening assistance, and dedicated expert guidance.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "On-Demand Troubleshooting and Root-Cause Incident Diagnostics from Senior Experts",
                  "Proactive Configurations Auditing, Maintenance and Systems Hardening Support",
                  "Expert Strategic Architecture Consulting Tailored to Your Specific Objectives",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Maintain absolute operational stability. Reach out to our senior technical support engineers today to discuss how we can secure and optimize your environments."
                </p>
