...
const features = [
  {
    ...
    description:
      "We analyze industrial control systems (ICS/SCADA) to detect security flaws, operational vulnerabilities, and potential process risks.",
    icon: Network,
  },
  {
    title: "Critical Infrastructures Security",
    description:
      "We evaluate the security of critical infrastructures to ensure absolute protection against cyber-physical threats and targeted attacks.",
    icon: ShieldAlert,
  },
  {
    title: "Compliance with Industrial Standards",
    description:
      "We verify compliance with international industrial standards (such as IEC 62443, NIST SP 800-82) to ensure safe operations.",
    icon: CheckCircle2,
  },
];
...
const subFeatures = [
  {
    ...
    description:
      "We identify specific technical risks related to PLCs, RTUs, and OT/IT convergence leaks, proposing robust mitigation blueprints.",
    icon: Activity,
  },
  {
    title: "Actionable Reporting & Remediations",
    description:
      "We provide a comprehensive technical report of findings with practical, evidence-led recommendations to reinforce security and continuity.",
    icon: FileText,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Industrial System Assessment</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone offers a complete assessment of industrial systems (OT) to guarantee their operational security, physical resilience, and alignment with industry standards.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Industrial Assessment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="INDUSTRIAL SECURITY" className="mb-10" />
            <motion.h2
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="INDUSTRIAL STANDARDS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Expose Operational Technology Risks
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR SECURE OT GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Expert in Secure Industrial Systems
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports your organization in evaluating and reinforcing the security of your industrial and SCADA setups. Contact us for a detailed OT configuration assessment, network segmentation review, and playbooks aligned with industrial requirements.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Audit of SCADA Networks, PLC/RTU Parameters, and OT/IT Segmentations",
                  "IEC 62443 and NIST SP 800-82 Standards Alignment and Compliance Assessments",
                  "Actionable Remediation Blueprints to Mitigate Process Risks without Interrupting Production",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Secure your industrial automation boundaries. Reach out to our SCADA/ICS assessment experts today to perform a comprehensive physical and operational technology check."
                </p>
