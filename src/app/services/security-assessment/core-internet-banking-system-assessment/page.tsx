...
const features = [
  {
    ...
    description:
      "We review Core Banking systems to evaluate their reliability, transactional functionality, and data security.",
    icon: Network,
  },
  {
    title: "Security Protocols Assessment",
    description:
      "We examine online banking security protocols and API interconnections to identify weaknesses and potential fraud points.",
    icon: ShieldAlert,
  },
  {
    title: "Compliance with Financial Regulations",
    description:
      "We verify systems compatibility with banking regulations, SWIFT Customer Security Programme, and PCI-DSS standards.",
    icon: CheckCircle2,
  },
];
...
const subFeatures = [
  {
    ...
    description:
      "We identify specific technical risks related to complex multi-tiered banking structures and propose targeted mitigation strategies.",
    icon: Activity,
  },
  {
    title: "Actionable Reporting & Remediations",
    description:
      "We provide a comprehensive technical report with detailed prioritizations and clear proof-of-concept evidence for banking operators.",
    icon: FileText,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Core Banking Assessment</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-[4.5rem] font-extrabold tracking-tighter text-white leading-[1] mb-6 uppercase">
              Core & Internet Banking Assessment
            </h1>
            ...
            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone conducts comprehensive assessments of Core Banking and Internet Banking systems to ensure their solidity, transactional security, and absolute compliance.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Banking Assessment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="FINANCIAL SECURITY" className="mb-10" />
            <motion.h2
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="BANKING HYGIENE STANDARDS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR FINANCIAL SECURITY GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Partner in Banking Security
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports your financial institution in evaluating and strengthening the security of your Core Banking and Internet Banking setups. Contact us for SWIFT CSP assessment, transaction audits, and dedicated compliance playbooks.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Security Audits of Core Databases, API Gateways, and Transaction Integrity",
                  "Alignment and Validation with International Standards: SWIFT CSP & PCI-DSS",
                  "Evidence-Led Vulnerability PoCs and Custom Security Recommendations for Financial Ops",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Protect your core assets against fraudulent transactions. Reach out to our banking infrastructure specialists today to perform a comprehensive transactional security check."
                </p>
