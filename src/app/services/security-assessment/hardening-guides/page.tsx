...
const features = [
  {
    ...
    description:
      "NIST recommendations, including publication series such as NIST SP 800-53 and NIST SP 800-171, are deeply integrated to ensure compliance and security.",
    icon: CheckCircle2,
  },
  {
    title: "SANS Guides",
    description:
      "We rely on detailed SANS system guidelines, which offer fine-grained configurations to lock down systems and guarantee enhanced posture security.",
    icon: BookOpen,
  },
  {
    title: "CISA Security Standards",
    description:
      "CISA requirements are systematically applied to develop configurations that stand up to advanced, real-world cyber threats.",
    icon: ShieldAlert,
  },
];
...
const subFeatures = [
  {
    title: "CIS & Microsoft Standards",
    description:
      "We utilize CIS Benchmarks and Microsoft Security Baselines to offer cross-platform security configurations aligned with global standards.",
    icon: Sliders,
  },
  {
    title: "Custom Hardening Blueprints",
    description:
      "An effective system hardening guide establishes rigorous security baselines customized to your operating systems, active directories, and network devices.",
    icon: Zap,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Hardening Guides Development</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-[4.5rem] font-extrabold tracking-tighter text-white leading-[1] mb-6 uppercase">
              Hardening Guides Development
            </h1>
            ...
            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone develops comprehensive, cross-platform hardening guides integrating international security standards to immunize your environments against cyberattacks.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Hardening Guides <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="GLOBAL STANDARDS" className="mb-10" />
            <motion.h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((service, idx) => (
              ...
              >
                ...
                >
                  Request Guides <ArrowRight size={14} />
                </Link>
              </motion.div>
            ))}
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="BASELINE RESILIENCE" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Uphold Baseline Security Configuration
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR SECURE HARDENING GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Hardening Configuration Expert
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports your organization in drafting, establishing, and validating solid system hardening guides based on international benchmarks. Contact our engineers to lock down OS configurations and eliminate common entry points.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Tailored Hardening Frameworks Compliant with NIST, SANS, and CIS Benchmarks",
                  "Strict System, OS, Hypervisor, and Firewall Configuration Lockdowns",
                  "Ongoing Support for Custom Hardening Deployments and Continuous Verification",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Immunize your IT infrastructure against vulnerability exploitation. Reach out to our system hardening specialists today to draft robust CIS/NIST compliance hardening guides."
                </p>
                <div className="pt-10 border-t border-white/10">
                  ...
                  >
                    Request Guides <ArrowRight size={18} />
                  </Link>
                </div>
              </div>
            </motion.div>
