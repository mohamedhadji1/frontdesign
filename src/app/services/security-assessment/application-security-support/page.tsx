...
const features = [
  {
    title: "In-depth Application Analysis",
    description:
      "We evaluate applications to identify vulnerabilities, logical flaws, and code-level weaknesses.",
    icon: Network,
  },
  {
    title: "Implementation of Security Measures",
    description:
      "We implement adapted security measures, such as strong authentication, session tokens, and strict access controls.",
    icon: Settings,
  },
  {
    title: "Security Testing and Assessments",
    description:
      "We perform automated and manual security tests to identify weaknesses and potential adversarial entry points.",
    icon: ShieldAlert,
  },
];
...
const subFeatures = [
  {
    title: "Training & Developer Awareness",
    description:
      "We offer tailored awareness sessions for engineering teams to reinforce secure development practices (SSDLC) and OWASP standards.",
    icon: CheckCircle2,
  },
  {
    title: "Monitoring & Maintenance",
    description:
      "We provide regular monitoring and continuous maintenance to guarantee the durability and sustainability of application security gates.",
    icon: Activity,
  },
];

export default function ApplicationSecuritySupportPage() {
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Application Security Support</span>
            </div>
            ...
            <HeroTypeLine
              items={["Source code securing", "SAST & DAST Testing", "Secure Software Development Life Cycle (SSDLC)"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone offers customized support to enhance the security of your existing applications or those under development, integrating seamless protection at every layer of the SDLC.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Application Support <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="APPLICATION SECURING" className="mb-10" />
            <motion.h2
            ...
            >
              Support for Advanced Securing
            </motion.h2>
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              We integrate automated security gates into your CI/CD pipelines, train your developers, and audit your critical APIs for flawless impermeability.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="SSDLC HYGIENE STANDARDS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Continuous Engineering Resilience
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR APPLICATION SEGMENT SECURITY" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Partner in Application Security
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports you in securing your applications against complex cyber threats and vulnerabilities. Contact us for security coaching, SSDLC implementation, and developer training tailored to your goals.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "End-to-End Code Review, API Integrity Checks, and Vulnerability Posture Mapping",
                  "Adaptable Application-Layer Security Policies, Access Controls, and JWT Strategy",
                  "Developer Security Training, Team Enablement, and Automated Pipeline (SSDLC) Security Gates",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Ensure application security baseline robustness from inception to release. Contact our application security engineers today to conduct a detailed review of your software development pipeline."
                </p>
