...
const features = [
  {
    ...
    description:
      "We review the key components of your systems, evaluating configurations, robustness, and security under actual stress.",
    icon: Server,
  },
  {
    title: "Vulnerability and Risk Assessment",
    description:
      "We identify potential security flaws, misconfigurations, and software risks within your complex IT infrastructures.",
    icon: ShieldAlert,
  },
  {
    title: "Compliance with Standards",
    description:
      "We verify compliance with industry security standards and benchmarks to ensure an optimal system security posture.",
    icon: CheckCircle2,
  },
];
...
const subFeatures = [
  {
    ...
    description:
      "We provide you with a comprehensive report of our findings, accompanied by prioritized recommendations to strengthen security and system reliability.",
    icon: FileText,
  },
  {
    title: "Post-Assessment Support",
    description:
      "We provide post-assessment follow-up and implementation guidance to help your technical teams continuously improve system defenses.",
    icon: Settings,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Technical Assessment</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone offers an in-depth technical assessment service, evaluating IT systems in detail to ensure their security, robustness, and performance.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Technical Assessment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="SYSTEMS EVALUATION" className="mb-10" />
            <motion.h2
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="TECHNICAL STANDARDS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Uphold Robust Systems Security
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR SYSTEMS RELIABILITY GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Partner in Security and Reliability
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports you with its comprehensive technical assessment services to guarantee the security, scalability, and absolute compliance of your systems. Contact us for custom auditing options and robust remediation roadmaps.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Evaluations of Server Configurations, Roles and access controls",
                  "Vulnerability Identification with Hand-Validated Proofs-of-Concepts (PoCs)",
                  "Technical Recommendations Tailored to Your Specific Software and Hardware Assets",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Expose weaknesses before adversaries exploit them. Reach out to our technical assessment specialists today to perform a complete system configuration check."
                </p>
