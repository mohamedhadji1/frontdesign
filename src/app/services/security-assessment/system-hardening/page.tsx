...
const features = [
  {
    ...
    description:
      "We identify weak points, insecure ports, and system vulnerabilities to establish a highly customized, robust hardening strategy.",
    icon: ShieldAlert,
  },
  {
    title: "Configuration and Setup",
    description:
      "We apply strict configurations and kernel settings to strengthen system resistance in accordance with global standards: CIS, Microsoft baselines.",
    icon: Settings,
  },
  {
    title: "Security Configuration Guides",
    description:
      "We develop and reinforce Hardening guides, access authorizations, and local host security policies to systematically mitigate lateral risk.",
    icon: Lock,
  },
];
...
const subFeatures = [
  {
    ...
    description:
      "We test and install the latest security patches to permanently remediate exposed vulnerabilities and ensure optimal protection baselines.",
    icon: CheckCircle2,
  },
  {
    title: "Continuous Monitoring & Maintenance",
    description:
      "We provide ongoing checks to maintain hardened security configuration postures and continuously deploy security updates under load.",
    icon: Activity,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">System Hardening</span>
            </div>
            ...
            <HeroTypeLine
              items={["Active attack surface reduction", "Closing OS vulnerabilities", "Application of CIS & DoD STIG standards"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone offers expert system hardening services to lock down OS layers, restrict access, and drastically reduce the risk of successful cyber intrusions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request Hardening <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="HARDENING METHODOLOGY" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              We deactivate vulnerable protocols, configure advanced defense mechanisms at the kernel level, and strengthen local access policies.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="OS DE-RISKING STANDARDS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Uphold Host Security Baselines
            </motion.h2>
          </div>
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR HOST SECURITY GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Partner in Host Securing
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone supports your organization in evaluating and hardening your IT assets against lateral and perimeter threats. Contact us for detailed system hardening support, OS-level security patches validation, and continuous baseline maintenance.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "System and OS-Level Hardening Deployments compliant with CIS Benchmarks",
                  "Vulnerability Identification and Prompt Security Patch Deployments",
                  "Hardening Guides Drafting and Team Training for Continuous Host Defenses",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Deactivate vulnerable protocols and secure host layers. Contact our system hardening engineers today to perform a complete checkup of your system configuration postures."
                </p>
