    ...
    <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          ...
          alt="Physical Penetration Testing Cover"
          fill
          priority
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 font-light mb-10 leading-relaxed">
            Test the limits of your physical perimeter. Identify unauthorized access points, hardware tampering risks, and social engineering vulnerabilities through real-world adversarial emulation.
          </p>
