...
const steps = [
  ...
  },
  {
    ...
    description: "We offer post-audit follow-up to help you implement recommendations and ensure continuous and secure Cloud usage.",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-xl">
                Keystone offers a comprehensive audit of Cloud environments to ensure the security, compliance, and efficiency of your Cloud resources.
              </p>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm p-4">
                <img src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=1200&auto=format&fit=crop" alt="Cloud Audit" className="rounded-xl w-full object-cover h-[350px]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16 max-w-4xl mx-auto p-8 bg-zinc-950 text-white rounded-2xl border border-zinc-800 text-center">
            ...
            <p className="text-zinc-400 text-sm max-w-2xl mx-auto leading-relaxed mb-6">
              Keystone supports you in auditing and securing your Cloud environments. Contact us for an in-depth evaluation and recommendations tailored to your needs.
            </p>
