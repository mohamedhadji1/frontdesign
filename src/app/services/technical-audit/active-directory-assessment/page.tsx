        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <HeroTypeLine
                items={["IAM & GPO securing", "Eradication of lateral attack paths", "AD configuration audit"]}
              />

              <p className="text-lg text-zinc-400 mb-8 leading-relaxed max-w-xl">
                Keystone conducts in-depth audits of Active Directory infrastructures to guarantee their security, performance, and compliance.
              </p>
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm p-4">
                <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=1200&auto=format&fit=crop" alt="Active Directory Audit" className="rounded-xl w-full object-cover h-[350px]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16 max-w-4xl mx-auto p-8 bg-zinc-950 text-white rounded-2xl border border-zinc-800 text-center">
            ...
            <p className="text-zinc-400 text-sm max-w-2xl mx-auto leading-relaxed mb-6">
              Keystone supports you in auditing and strengthening the security of your Active Directory infrastructures. Contact us for a detailed evaluation and tailored recommendations.
            </p>
