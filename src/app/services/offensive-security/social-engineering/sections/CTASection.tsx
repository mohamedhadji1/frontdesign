        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <span className="text-sm font-medium uppercase tracking-widest">
              Keystone: Your Partner in Human Resilience
            </span>
          </motion.div>
          ...
          >
            Keystone supports you in assessing and strengthening human resilience against social engineering attacks. 
            Contact us to improve security awareness.
          </motion.p>
        </div>
