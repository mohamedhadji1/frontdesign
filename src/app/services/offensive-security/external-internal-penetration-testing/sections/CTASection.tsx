        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <span className="text-sm font-medium uppercase tracking-widest">
              Keystone: Your Partner in Cutting-Edge Security
            </span>
          </motion.div>
          ...
          >
            Ready for a thorough and expert security assessment?
          </motion.h2>
          ...
          >
            Keystone provides you with a team of expert pentesters to assess and strengthen 
            the security of your infrastructure. Contact us today.
          </motion.p>
        </div>
