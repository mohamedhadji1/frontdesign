        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <span className="text-sm font-medium uppercase tracking-widest">
              Keystone: Your Partner in Physical Security
            </span>
          </motion.div>
          ...
          >
            Is your physical perimeter truly secure?
          </motion.h2>
          ...
          >
            Keystone provides its expertise to assess and strengthen the physical security of your organization. 
