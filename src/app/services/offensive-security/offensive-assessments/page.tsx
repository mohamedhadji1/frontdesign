...
const mainAssessments = [
  ...
  },
  {
    ...
    description:
      "Testing the human element of your security through carefully crafted simulated phishing, vishing, and physical impersonation campaigns.",
    href: "/services/offensive-security/social-engineering",
    icon: Users,
  },
];
...
const secondaryAssessments = [
  {
    ...
    description:
      "Evaluating the physical security controls of your facilities by attempting unauthorized access to restricted areas and secure server premises.",
    href: "/services/offensive-security/physical-intrusion-test",
    icon: Key,
  },
  {
    title: "Hardware & Firmware Analysis",
    description:
      "Deep technical analysis of hardware components, microcontrollers, IoT devices, and firmware to uncover latent vulnerabilities and supply-chain backdoors.",
    href: "/services/offensive-security/hardware-testing-reverse-engineering",
    icon: Cpu,
  },
];
          ...
          >
            ...
            <HeroTypeLine
              items={[
                ...
                "Hardware & Physical Auditing",
              ]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Our offensive assessments simulate advanced real-world threats to uncover security blind spots across your technology, processes, and people with actionable remediation guidance.
            </p>

            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              <Link
                href="/contact?service=offensive-assessments"
              ...
              >
                Schedule Assessment Track <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="ADVANCED TESTING" className="mb-10" />
            <motion.h2
            ...
            >
              We thoroughly examine your applications, perimeters, and employee awareness levels under realistic attack scenarios.
            </motion.p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {mainAssessments.map((service, idx) => (
              <motion.div
                key={service.title}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {secondaryAssessments.map((item, idx) => (
              <motion.div
                key={item.title}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <Link
                      href={item.href}
                      className="inline-flex items-center gap-2 font-bold uppercase tracking-widest text-[10px] text-red-600 hover:gap-4 transition-all mt-6"
                    >
                      Explore Offerings <ArrowRight size={14} />
                    </Link>
                  </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Robust Testing, Rigorous Verification
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone assists your business in conducting deep technical audits, exposing design vulnerabilities, and verifying perimeter safety.
              </p>
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Expose weaknesses before they can be exploited. Speak directly to our senior auditing consultants today."
                </p>
