      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-12">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
              ...
              <span className="text-red-400">
                Hardware Testing and Reverse Engineering
              </span>
            </div>
          </motion.div>
          ...
          <p className="mb-10 mt-6 max-w-3xl text-lg font-medium leading-relaxed text-zinc-300 md:text-xl lg:text-2xl">
            Keystone&apos;s Hardware Testing and Reverse Engineering service ensures the safety, 
            integrity, and optimal functionality of your hardware components through in-depth analysis.
          </p>
