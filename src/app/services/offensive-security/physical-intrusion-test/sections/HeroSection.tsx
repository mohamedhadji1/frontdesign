      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-12">
        ...
        >
          ...
          <p className="mb-10 mt-6 max-w-3xl text-lg font-medium leading-relaxed text-zinc-300 md:text-xl lg:text-2xl">
            Keystone&apos;s physical penetration testing service assesses the resilience of your physical 
            infrastructure by simulating realistic attacks to identify potential vulnerabilities.
          </p>
