...
const methodologies = [
  ...
  },
  {
    ...
    description:
      "We carry out exhaustive forensic reviews and post-incident gap analyses to systematically strengthen and refine crisis management blueprints.",
    icon: CloudCog,
  },
];
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Cyber Crisis Management</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Establish Your Framework <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Manage Cyber Crisis Elegantly
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone is ready to assist your organization in establishing robust incident coordination playbooks and resilient crisis management frameworks.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Development of National and Sectoral Crisis Directives",
                  "Structured Multi-Agency Response Strategies & Governance",
                  "Expert-Led Incident Scenario Tabletop Exercises",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Don't wait for a crisis to test your operational readiness. Reach out to our crisis specialists today to outline your corporate response framework."
                </p>
