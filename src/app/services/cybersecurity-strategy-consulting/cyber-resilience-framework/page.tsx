...
const methodologies = [
  {
    ...
    description:
      "We conduct an exhaustive risk analysis to map potential threats facing your organization, establishing defensive posture priorities.",
    icon: Network,
  },
  {
    title: "Resilience Strategies",
    description:
      "We design proactive strategies to strengthen your organization's capability to absorb, resist, and withstand sophisticated digital attacks.",
    icon: FileCheck,
  },
  {
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">Cyber Resilience Framework</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Proactive Resilience Strategy & Governance Design",
                  "Meticulous Incident Recovery & Playbooks Audits",
                  "Continuous Adaptive Defense Planning & Scoping Support",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Respect security policies and guarantee uninterrupted resilience. Contact our data protection and resilience experts today to design your customized cyber resilience program."
                </p>
