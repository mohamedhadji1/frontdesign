...
const methodologies = [
  ...
  },
  {
    ...
    description:
      "We evaluate compliance with current policies and regulatory frameworks, identifying critical gaps and proposing strategic recommendations.",
    icon: FileCheck,
  },
  {
  ...
  },
  {
    ...
    description:
      "Based on our assessments, we formulate precise strategic recommendations to continuously improve your overall cybersecurity maturity.",
    icon: ServerCog,
  },
  {
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Keystone proposes its expertise to assess national capabilities and cybersecurity maturity. We work with organizations and governments to establish a comprehensive and accurate assessment of cybersecurity infrastructures, policies, and operational capabilities.
            </p>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Determine Your Cyber Maturity
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone acts as your primary strategic partner to evaluate and benchmark organizational and national maturity, protecting mission-critical processes.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Mapping of Infrastructure Capabilities",
                  "Maturity Posture Benchmarked to International Frameworks",
                  "Strategic Guidance and Actionable Improvement Roadmaps",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Ensure your organizational assets are completely resilient to evolving threats. Reach out today to schedule your comprehensive cybersecurity capacity assessment."
                </p>
