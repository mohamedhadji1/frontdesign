...
const methodologies = [
  {
    ...
    description:
      "We conduct a comprehensive assessment of national and sectoral infrastructures, threats, and compliance policies to establish an accurate diagnosis.",
    icon: Search,
  },
  {
  ...
  {
    title: "Proactive Adaptability",
    description:
      "We continually track the evolution of global threat landscapes and dynamically update cybersecurity directives to ensure proactive safety.",
    icon: Activity,
  },
  {
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">National & Sectoral Strategy</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Diagnostic of Strategic Threat Landscapes",
                  "Alignment of National Strategies with Global Security Postures",
                  "Actionable Directives to Build Long-Term Digital Sovereignty",
                ].map((item) => (
                  <motion.div
                    key={item}
