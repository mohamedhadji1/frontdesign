...
export default function NationalSectoralStrategyPage() {
  const breadcrumbs = [
    ...
    { label: "National & Sectoral Strategy", href: "/services/cybersecurity-strategy-consulting/development-of-national-and-sectoral-cybersecurity-strategy" },
  ];

  const methodologies = [
    {
      title: "In-depth Diagnostic",
      description: "We conduct a comprehensive assessment of infrastructures, threats, and vulnerabilities specific to each sector to establish an accurate diagnosis.",
      icon: Search,
    },
    {
      title: "Strategic Alignment",
      description: "We design strategies that align with national and sectoral objectives, integrating best practices to strengthen cybersecurity on a large scale.",
      icon: Compass,
    },
    {
      title: "Intersectoral Collaboration",
      description: "Our approach promotes cross-sector collaboration, enabling unified management of cross-cutting threats and better resilience against attacks.",
      icon: Users,
    },
    {
      title: "Monitoring and Adaptability",
      description: "We monitor the evolution of threats and constantly adapt strategies to ensure continuous and proactive protection.",
      icon: Activity,
    },
    {
      title: "Strengthening Digital Sovereignty",
      description: "Our strategies strengthen digital sovereignty by protecting vital infrastructures and strategic national data.",
      icon: GlobeLock,
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                National and Sectoral Cybersecurity <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">Strategy</span>
              </h1>
              <HeroTypeLine
            ...
            <div className="lg:w-1/2 relative">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm p-4">
                <img
                  ...
                  alt="National and Sectoral Cybersecurity Strategy"
