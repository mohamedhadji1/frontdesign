...
const features = [
  {
    ...
    description:
      "We are committed to supporting you at every single stage of the certification process, helping you seamlessly navigate through the complex requirements of ISO 27001 to solidify your overall security posture.",
    icon: ShieldCheck,
  },
  {
    title: "A Trusted Partner",
    description:
      "Keystone is recognized for its highly advanced expertise in the information security field. Our certified consultants offer both strategic and practical advice to help you reach ISO 27001 certification with complete confidence.",
    icon: Users,
  },
  {
    title: "Proven Success Stories",
    description:
      "We have helped numerous companies successfully secure their ISO 27001 certification. Their success stories illustrate our deep ability to transform complex challenges into practical opportunities for security excellence.",
    icon: Award,
  },
];
...
const subFeatures = [
  {
    title: "Our References Speak For Us",
    description:
      "We are proud of the robust references we have built over years of delivering client-centric security services. The organizations we have supported stand as living proof of our capacity to secure a successful ISO 27001 journey.",
    icon: Bookmark,
  },
  {
    title: "The Path to Recognition",
    description:
      "ISO 27001 certification goes beyond compliance. It is a mark of trust for your partners, clients, and stakeholders; demonstrating your strong commitment to data security and information protection.",
    icon: FileCheck2,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              <span>GRC</span>
              <ChevronRight size={8} />
              <span className="text-white/60">ISO 27001 Certification Support</span>
            </div>
            ...
            <HeroTypeLine
              items={["Recognition", "Security", "Compliance"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              At Keystone, we understand that ISO 27001 certification is much more than a seal of compliance. It is the tangible proof of your absolute commitment to information security. Our support service is the fruit of years of experience, backed by numerous references and success stories.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request support for Secure ISO 27001 certification<ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="ISO 27001 PATHWAYS" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              Achieve highly trusted, international certification to reassure stakeholders and solidy information security.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="RELIABLE RECOGNITION" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR PRESTIGIOUS PREPARATION GUIDE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone is here to make your journey to ISO 27001 certification a successful and highly rewarding experience. Contact us today to discover how we can help you secure your valuable data assets and achieve this world-class recognition.
              </p>
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Ready to achieve ISO 27001 certification? Contact us today to learn how our seasoned consultants can easily guide your organization to security excellence."
                </p>
                <div className="pt-10 border-t border-white/10">
                  ...
                  >
                    Start Certification Journey <ArrowRight size={18} />
                  </Link>
                </div>
              </div>
            </motion.div>
