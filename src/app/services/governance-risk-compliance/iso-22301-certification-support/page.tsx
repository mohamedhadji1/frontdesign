...
const approachItems = [
  {
    ...
    description: "We conduct exhaustive Business Impact Analyses to pinpoint critical workflows, calculate maximum tolerable outages, and define precise RTO/RPO targets.",
    icon: Zap,
  },
  {
    title: "BCP/DRP Blueprint Strategy",
    description: "Our continuity specialists construct highly practical Business Continuity and Disaster Recovery plans tailored to your infrastructure and operational constraints.",
    icon: Users2,
  },
  {
    title: "Simulated Drills & Audits",
    description: "We orchestrate realistic, high-fidelity crisis scenarios and full-scope mock audits to test plans and ensure your organization is completely audit-ready.",
    icon: ShieldCheck,
  },
];
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request support for Secure ISO 22301 certification <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            ...
            <h2 className="text-3xl lg:text-5xl font-extrabold mb-6 tracking-tighter uppercase leading-[0.95] text-zinc-900">
              Our Approach to ISO 22301 Certification
            </h2>
            <p className="text-lg text-zinc-600 max-w-2xl mx-auto font-medium">
              We design and implement highly resilient Business Continuity Management Systems that protect critical operations and achieve international recognition.
            </p>
          </div>
