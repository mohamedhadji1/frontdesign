...
const features = [
  {
    ...
    description:
      "We design, build, and integrate privacy controls directly into your existing ISO 27001 ISMS to form a robust Privacy Information Management System.",
    icon: Search,
  },
  {
    title: "Data Controller & Processor Alignment",
    description:
      "Whether you act as a personally identifiable information (PII) controller or processor, we tailor privacy audits to secure your operational parameters.",
    icon: Lock,
  },
  {
    title: "Privacy Risk and Compliance Auditing",
    description:
      "We run deep gaps audits against ISO 27701 requirements, mapping out risk treatment plans to ensure continuous data confidentiality.",
    icon: ShieldCheck,
  },
];
...
const subFeatures = [
  {
    title: "Continuous Privacy Assurance",
    description:
      "We assist your engineering, operational, and legal departments in maintaining privacy controls alongside corporate releases.",
    icon: BookmarkCheck,
  },
  {
    title: "Developer & Staff Enablement",
    description:
      "We train your engineers and operation teams on secure data processing, data minimization, and privacy-by-design guidelines.",
    icon: Zap,
  },
];
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex-grow flex flex-col justify-center items-center text-center lg:items-start lg:text-left py-12 lg:py-16">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">ISO 27701</span>
            </div>
            ...
            <HeroTypeLine
              items={["Privacy Management", "Data Protection", "PIMS Assurance"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              At Keystone, our ISO 27701 certification support service assists your organization in expanding your ISO 27001 ISMS to incorporate a world-class Privacy Information Management System (PIMS).
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Request ISO 27701 Assessment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="PRIVACY MANAGEMENT" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              We design, document, and build privacy controls aligned with ISO 27701 to protect sensitive consumer and operations data.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="PRIVACY ENABLEMENT" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR PRIVACY ASSURANCE GUARANTEE" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Keystone: Your Privacy Security Partner
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone helps your enterprise map out data streams, identify compliance gaps, and secure corporate resources under strict ISO 27701 privacy baselines.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "ISO 27701 PIMS Architecture & Secure Core Documentation Support",
                  "Deep Gaps Assessment and Data Minimization Audit Guidelines",
                  "Developer Secure Coding & Continuous Privacy Enforcement Guidelines",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Maintain trust, enforce security. Contact our ISO 27701 GRC advisory team today to establish a resilient Privacy Information Management System."
                </p>
