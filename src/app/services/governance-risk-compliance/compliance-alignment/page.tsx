...
const helpServices = [
  {
    title: "In-Depth Initial Assessment",
    description:
      "We begin with a highly detailed evaluation of your current operations compared against target norms, laws, and regulations, mapping out all compliance gaps to establish an optimized action plan.",
    icon: ClipboardCheck,
  },
  {
    title: "Customized Planning",
    description:
      "Our team engineers a custom-tailored roadmap for your enterprise, outlining precise steps, milestones, and timelines to reach and easily maintain full security compliance.",
    icon: Compass,
  },
  {
    title: "Support & Specialized Training",
    description:
      "We support you at every stage of your transformation, providing ongoing expert advice, complete security resources, and specialized training to embed compliance best practices.",
    icon: GraduationCap,
  },
];
...
const approachCards = [
  {
    ...
    description:
      "Our specialists carry advanced expertise across a wide, comprehensive array of standards, ensuring support perfectly aligned with your business demands.",
    icon: Award,
  },
  {
    title: "Adaptability & Flexibility",
    description:
      "We synchronize with your corporate pace, smoothly adjusting our workflows to suit your dynamic operational requirements while safeguarding compliance.",
    icon: Zap,
  },
  {
    title: "Concrete Results",
    description:
      "Our core focus is enabling durable, long-term compliance that actively strengthens stakeholder confidence and accelerates your commercial growth.",
    icon: TrendingUp,
  },
];

export default function ComplianceAlignmentPage() {
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex flex-col items-center text-center lg:items-start lg:text-left h-full justify-center">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              <span>GRC</span>
              <ChevronRight size={8} />
              <span className="text-white/60">Compliance Alignment</span>
            </div>
            ...
            <HeroTypeLine
              items={["Transformation", "Security", "Standards"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Compliance with standards and regulations is a crucial step for any business looking to maintain its security, reputation, and competitiveness. At Keystone, our personalized support service guides you throughout the compliance process, allowing you to effectively navigate the complex requirements of norms, standards, laws, and regulations.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Start Your Alignment <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            ...
            >
              We guide you from standard requirements evaluation down to building reliable security workflows.
            </motion.p>
          </div>
      ...
      {/* Success-Driven Approach Section */}
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="OUR APPROACH TO SUCCESS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="WHY CHOOSE KEYSTONE" className="!justify-start mb-6" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Our approach is deeply custom, offering personalized support designed to help you easily navigate standard constraints, laws, and regulations.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Personalized Compliance Workflows",
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Ready to achieve seamless compliance and succeed in your digital transformation? Contact our experts today to construct a sustainable strategy."
                </p>
