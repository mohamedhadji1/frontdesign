...
const approachCards = [
  {
    ...
    description:
      "We begin our journey together with an in-depth, rigorous evaluation of your current operations compared against target international frameworks, identifying gap areas and designing a custom strategic path.",
    icon: ClipboardList,
  },
  {
    title: "Strategic Planning",
    description:
      "Our experienced team designs a custom-tailored strategy for your organization, mapping out critical steps to align and easily maintain compliance with each individual framework.",
    icon: Target,
  },
  {
    title: "Expert Support",
    description:
      "We support your teams step-by-step, providing expert knowledge, training resources, and hands-on guidance to easily adopt industry-leading security controls.",
    icon: Users,
  },
];
...
const strengthsCards = [
  {
    ...
    description:
      "Our team of consultants has advanced, up-to-date expertise in each of the listed standards, delivering precise and highly certified guidance tailored for your industry.",
    icon: Award,
  },
  {
    title: "Flexibility & Adaptability",
    description:
      "We continuously adjust our alignment methods to fit your evolving business dynamic, ensuring continuous adherence to compliance rules without interrupting output.",
    icon: ThumbsUp,
  },
  {
    title: "Tangible Results",
    description:
      "Our objective is to build an extremely solid, continuous compliance foundation that actively protects your organization's reputation and client trust.",
    icon: ShieldAlert,
  },
];
...
export default function InternationalStandardsPage() {
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex flex-col items-center text-center lg:items-start lg:text-left h-full justify-center">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              ...
              <ChevronRight size={8} />
              <span className="text-white/60">International Standards</span>
            </div>
            ...
            <HeroTypeLine
              items={["ISO 27001", "PCI DSS", "GDPR", "SOC 2", "SWIFT"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              Compliance with standards and regulations is essential to guarantee the security, confidentiality, and stakeholder trust in your company. At Keystone, our specialized support service guides you through the process of complying with specific standards such as ISO27001, ISO22301, ISO27701, PCI/DSS, HIPAA, GDPR, SWIFT CSP, NIST CSF, and SOC2.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Secure Your Compliance <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      {/* Our Dedicated Approach Section */}
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="OUR APPROACH TO COMPLIANCE" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 font-medium leading-relaxed">
              We leverage detailed analysis and customized strategic roadmaps to simplify standard compliance.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {approachCards.map((service, idx) => (
              <motion.div
                key={service.title}
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="OUR STRENGTHS" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Why We Deliver More
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="WHY KEYSTONE" className="!justify-start mb-6" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Your Assured Journey
              </motion.h2>
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                At Keystone, our priority is guaranteeing a highly efficient, successful transformation that allows your company to comply with key international security standards.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Laser Focus on Compliance Success",
                  "Deep Tailoring to Business Realities",
                  "Continuous Guidance and Long-Term Partnership",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Ready to advance your business toward international standards compliance? Contact us today to secure stakeholder trust and build sustainable processes."
                </p>
                <div className="pt-10 border-t border-white/10">
                  ...
                  >
                    Start Alignment <ArrowRight size={18} />
                  </Link>
                </div>
              </div>
            </motion.div>
