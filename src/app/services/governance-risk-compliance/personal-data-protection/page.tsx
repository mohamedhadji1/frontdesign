...
const features = [
  {
    title: "Responsible Management of Sensitive Data",
    description:
      "We help your organization establish highly responsible corporate management practices for personal data, guaranteeing its absolute safety and encryption throughout its entire lifecycle.",
    icon: ShieldAlert,
  },
  {
    title: "Absolute Regulatory Compliance",
    description:
      "We ensure your business remains in complete alignment with critical laws like the GDPR, implementing solid security frameworks to safeguard individual privacy rights.",
    icon: Sliders,
  },
  {
...
const subFeatures = [
  {
    title: "Personal Data Protection Expertise",
    description:
      "Our team of consultants carries deep experience in privacy compliance, supplying highly ethical, practical recommendations to manage sensitive data securely.",
    icon: BookmarkCheck,
  },
  {
    title: "Reinforce Corporate Credibility",
    description:
      "A transparent, highly compliant data protection standard actively strengthens client trust, boosting your business competitiveness and market authority.",
    icon: TrendingUp,
  },
];
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex flex-col items-center text-center lg:items-start lg:text-left h-full justify-center">
          ...
          >
            ...
            <HeroTypeLine
              items={["Confidentiality", "Integrity", "Compliance"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              At Keystone, our Personal Data Protection service ensures the confidentiality, integrity, and compliance of personal data. We work in close collaboration with your company to protect personal information in a highly responsible and compliant manner.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Secure Data Privacy <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="DATA PRIVACY PRINCIPLES" className="mb-10" />
            <motion.h2
            ...
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              We leverage analytical expertise and clear roadmap strategies to guarantee compliant, ethical data practices.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="RESPONSIBLE DATA GOVERNANCE" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Ethics & Trust
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR DATA PRIVACY PARTNER" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone is ready to assist your organization in establishing highly responsible and fully compliant personal data security standards. Reach out to our consultants to reinforce your information security.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed GDPR and Local Privacy Gap Assessments",
                  "Meticulous Record of Processing Activities Support (ROPA)",
                  "Custom Consent Strategy and Privacy Rights Governance Blueprint",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Respect user privacy and guarantee regulatory compliance. Contact our data protection experts today to outline your customized privacy program."
                </p>
