...
const helpCards = [
  {
    ...
    description: "We conduct detailed assessments to evaluate your compliance with legal and regulatory requirements specific to your sector, identifying gaps and proposing solutions.",
    icon: Eye,
  },
  {
    title: "Risk Analysis",
