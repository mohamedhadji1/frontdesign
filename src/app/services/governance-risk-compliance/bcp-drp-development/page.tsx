...
const features = [
  {
    title: "Tailor-made Plans for Your Company",
    description:
      "We understand the exact specifications of your corporate structure. Our BCP/DRP blueprints are customized to precisely target your critical assets and business risk scenarios.",
    icon: Wrench,
  },
  {
    title: "Anticipation & Extreme Reactivity",
    description:
      "We simulate worst-case scenarios and develop reactive, practical continuity blueprints to minimize downtime and secure business operations during unforeseen crises.",
    icon: Flame,
  },
  {
    title: "Expertise in Operational Resilience",
    description:
      "Our specialists have advanced experience in engineering BCP and DRP programs, assuring a proactive and reliable operational recovery standard under pressure.",
    icon: ShieldAlert,
  },
];
...
const subFeatures = [
  {
    title: "Plans Put to the Test",
    description:
      "The enterprises we have supported bear witness to the sheer robustness of our recovery strategies, allowing them to keep key operations flowing under extreme stress.",
    icon: BookmarkCheck,
  },
  {
    title: "Confidence and Preparation",
    description:
      "A resilient, tested BCP/DRP significantly reinforces partner trust and client retention, ensuring you can navigate any digital or physical crisis with absolute serenity.",
    icon: Award,
  },
];

export default function BCPDRPDevelopmentPage() {
    ...
    >
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 flex flex-col items-center text-center lg:items-start lg:text-left h-full justify-center">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-3 text-red-500 font-bold uppercase tracking-[0.2em] text-[10px]">
              <span>GRC</span>
              <ChevronRight size={8} />
              <span className="text-white/60">BCP & DRP Development</span>
            </div>
            ...
            <HeroTypeLine
              items={["Resilience", "Continuity", "Survival"]}
            />

            <p className="text-lg md:text-xl text-gray-300 font-medium tracking-wide mb-10 max-w-3xl mt-6 leading-relaxed">
              At Keystone, our business continuity and disaster recovery planning services ensure your company’s resilience faced with disruptions. We develop highly customized, detailed plans to survive crises with confidence and agility.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center lg:items-start">
              ...
              >
                Build BCP & DRP <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mb-20 bg-white relative">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="RECOVERY CAPABILITIES" className="mb-10" />
            <motion.h2
            ...
            >
              Survive Operational Crises
            </motion.h2>
            <p className="text-lg text-zinc-600 leading-relaxed font-medium">
              We engineer strategic continuity documentation to preserve business flow through extreme operational failures.
            </p>
          </div>
      ...
      <section className="mb-20 bg-zinc-50/30 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <SectionDivider title="GUARANTEED CONTINUITY" className="mb-10" />
            <motion.h2
              className="text-3xl lg:text-6xl font-extrabold text-zinc-900 mb-6 tracking-tighter uppercase leading-[0.95]"
            >
              Continuous Survival
      ...
      <section className="mb-20 bg-white">
        <SectionDivider title="YOUR RESILIENCE PARTNER" className="!justify-start mb-20" />
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-medium border-l-4 border-red-600 pl-8">
                Keystone is ready to assist your organization in drafting solid, highly responsive recovery plans. Contact our specialists today to reinforce your business operational survival.
              </p>
              <div className="flex flex-col gap-4 pt-6">
                {[
                  "Detailed Business Impact Analysis & Recovery Objectives (RTO / RPO)",
                  "Custom Tailored Disaster Recovery Strategy Drafting",
                  "Expert-Led Testing, Drills, and Team Crisis Management Exercises",
                ].map((item) => (
                  <motion.div
                    key={item}
            ...
            >
              <div className="relative bg-zinc-900 p-12 rounded-[3rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-zinc-300 text-xl font-light italic leading-relaxed mb-12">
                  "Insure your company against extreme system failures. Contact us today to map out highly practical operational resilience strategies."
                </p>
