...
import { ArrowRight, ShieldAlert, Lock, Eye, Cpu, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Evaluating Large Language Models for prompt injection, leakage, and validation flaws.",
    icon: ShieldAlert,
  },
  {
    title: "Adversarial ML Defense",
    description: "Hardening neural networks against evasion, poisoning, and extraction attacks.",
    icon: Lock,
  },
  {
    title: "Deepfake Detection",
    description: "Identifying synthetic media, deepfakes, and identity manipulation attempts across channels.",
    icon: Eye,
  },
];
...
const capabilities = [
  {
    title: "Jailbreak Audits",
    description: "Perform deep prompt-injection testing and jailbreak simulations to stress test model boundaries.",
    icon: ShieldAlert,
  },
  {
    title: "Adversarial Hardening",
    description: "Implement robust input filtering and validation boundaries to protect models from adversarial exploitation.",
    icon: Lock,
  },
  {
    title: "Synthetic Discovery",
    description: "Deploy specialized analytics to detect AI-generated deepfakes and fake identity footprints.",
    icon: Eye,
  },
  {
    title: "Security Review",
    description: "Evaluate the full application envelope hosting your AI system, checking APIs, containers, and databases.",
    icon: Cpu,
  },
];
...
const offers = [
  ...
  "AI-powered threat detection advisory",
];

export default function AISecurityThreatDefensePage() {
        ...
        <div className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center gap-8 px-4 pt-28 pb-40 sm:px-6 sm:pt-32 sm:pb-48 lg:flex-row lg:justify-between lg:gap-0 lg:px-12 lg:pt-24 lg:pb-28 lg:overflow-visible">
          ...
          <div className="flex w-full flex-col items-center gap-4 text-center sm:gap-6 lg:w-2/3 lg:items-start lg:gap-10 lg:text-left">
            ...
            <motion.h2 className="text-3xl font-bold leading-tight tracking-tight text-white max-w-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase">
              <TypingText text="AI Security & Threat Defense" delay={0.5} />
            </motion.h2>

            <p className="mt-4 max-w-2xl text-base font-medium tracking-wide text-gray-300 sm:text-lg md:text-xl">
              <TypingText text="Audit and protect Large Language Models and ML neural networks against evasion, poisoning, and data leakage." delay={2} />
            </p>
            <motion.div
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="Assessment / Threat / Hardening" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center px-4 sm:px-6">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl mb-8 positioning-title uppercase leading-[1.1]">
            Protect your neural architectures against advanced malicious exploitation.
          </h2>
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              As models become embedded in production processes, they introduce a distinct and high-risk operational attack surface. Adversaries are actively developing prompt engineering exploits, jailbreaks, data poisoning tricks, and evasion techniques.
            </p>
            <p>
              Keystone secures your AI models. We execute Large Language Model assessments, perform prompt injection testing, deploy machine learning threat defense guidelines, and build robust safety perimeters to verify secure application operations.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="DEFENSIVE CAPABILITIES" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.h2 className="text-3xl font-black tracking-tight md:text-5xl uppercase leading-[1.1]">
              Harden your AI system pipelines.
            </motion.h2>
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Contact our security researchers to schedule an LLM audit, verify container security, and protect your model investments against jailbreak methods.
            </motion.p>
          </motion.div>
