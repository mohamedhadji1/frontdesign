...
import { ArrowRight, BookOpen, Scale, Cpu, Lock, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Helping leadership understand emerging AI opportunities, regulatory parameters, and strategic risks.",
    icon: BookOpen,
  },
  {
    title: "Secure AI Usage Training",
    description: "Educating general staff on prompt safety, avoiding data leaks, and generative AI risks.",
    icon: Scale,
  },
  {
    title: "Technical AI Workshops",
    description: "Equipping technical and security teams with practical skills in prompt engineering, LLM security, and RAG.",
    icon: Cpu,
  },
];
...
const capabilities = [
  {
    ...
    description: "Host executive workshops to set high-level strategic objectives and outline governance models.",
    icon: BookOpen,
  },
  {
    title: "Guidelines Customization",
    description: "Co-develop clear internal AI use policies and prompting guidelines customized to your business tools.",
    icon: Scale,
  },
  {
    title: "Technical Upskilling",
    description: "Run hands-on coding labs on LLM APIs, secure vector integration, and validation design.",
    icon: Cpu,
  },
  {
    title: "Security Enablement",
    description: "Train your existing security operations center team to identify, triage, and defend against AI-focused exploits.",
    icon: Lock,
  },
];
...
const offers = [
  ...
  "Secure AI usage training",
  "Generative AI risk awareness",
  "AI for cybersecurity teams",
  "Responsible AI and data privacy training",
  "AI governance awareness",
  "Practical workshops on LLMs, RAG and AI agents",
  "Internal AI usage guidelines and best practices",
];

export default function AITrainingAwarenessPage() {
        ...
        <div className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center gap-8 px-4 pt-28 pb-40 sm:px-6 sm:pt-32 sm:pb-48 lg:flex-row lg:justify-between lg:gap-0 lg:px-12 lg:pt-24 lg:pb-28 lg:overflow-visible">
          ...
          <div className="flex w-full flex-col items-center gap-4 text-center sm:gap-6 lg:w-2/3 lg:items-start lg:gap-10 lg:text-left">
            <motion.h2 className="text-3xl font-bold leading-tight tracking-tight text-white max-w-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase">
              <TypingText text="AI Training & Awareness" delay={0.2} />
            </motion.h2>

            <p className="mt-4 max-w-2xl text-base font-medium tracking-wide text-gray-300 sm:text-lg md:text-xl">
              <TypingText text="Educate executives, business teams, and developers on prompt safety, privacy policies, and model security." delay={1.2} />
            </p>
            <motion.div
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="Awareness / Education / Skills" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center px-4 sm:px-6">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl mb-8 positioning-title uppercase leading-[1.1]">
            Build a security-first corporate culture around generative AI.
          </h2>
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              The fastest way for an enterprise to leak trade secrets is for untrained employees to paste proprietary databases, intellectual property, or source code into public LLMs. AI adoption requires systematic, risk-aligned guidance.
            </p>
            <p>
              Keystone upskills your enterprise. We conduct custom executive briefing sessions, teach secure prompting guidelines, run workshops on LLMs, vector search and autonomous agents, and train IT developers on defensive engineering.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="TRAINING CAPABILITIES" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.h2 className="text-3xl font-black tracking-tight md:text-5xl uppercase leading-[1.1]">
              Equip your workforce with secure AI skills.
            </motion.h2>
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Contact our training coordinators today to organize an AI threat awareness workshop or secure coding lab for your enterprise.
            </motion.p>
          </motion.div>
