...
import { ArrowRight, Radar, BrainCircuit, Cpu, Scale, Lock, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Enriching telemetry, accelerating alert triaging, and minimizing analyst fatigue.",
    icon: Radar,
  },
  {
    title: "Threat Intelligence Automation",
    description: "Aggregating, analyzing, and dispatching actionable indicators automatically.",
    icon: BrainCircuit,
  },
  {
    title: "Incident Response Playbooks",
    description: "Automating operational response workflows to neutralize incidents instantly.",
    icon: Cpu,
  },
];
...
const capabilities = [
  {
    ...
    description: "Upgrade your SIEM and SOAR systems with machine learning layers to automatically classify alert urgencies.",
    icon: Radar,
  },
  {
    title: "Threat Processing",
    description: "Use natural language models to read unstructured threat blogs and extract threat indicators dynamically.",
    icon: BrainCircuit,
  },
  {
    title: "Automated Reporting",
    description: "Generate regulatory-compliant post-incident reports instantly using AI, saving hours of developer documentation.",
    icon: Scale,
  },
  {
    title: "Vulnerability Triage",
    description: "Automate code scanning prioritization by linking findings directly to external threat intelligence feeds.",
    icon: Lock,
  },
];

const offers = [
  "AI-powered SOC enhancement",
...
export default function AICybersecurityOperationsPage() {
        ...
        <div className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center gap-8 px-4 pt-28 pb-40 sm:px-6 sm:pt-32 sm:pb-48 lg:flex-row lg:justify-between lg:gap-0 lg:px-12 lg:pt-24 lg:pb-28 lg:overflow-visible">
          ...
          <Breadcrumbs
            items={[
              ...
              { label: "Ai For Cybersecurity Operations" },
            ]}
          />
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="SOC / Operations / Automation" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center px-4 sm:px-6">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl mb-8 positioning-title uppercase leading-[1.1]">
            Empower security analysts with AI powered contextual intelligence.
          </h2>
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              Security teams today face massive alert backlogs and highly complex threat vectors. Manually triaging logs, formatting reports, and coordinating containment steps drains crucial resource capacity.
            </p>
            <p>
              Keystone integrates artificial intelligence layers into active security operations. We deploy AI-powered SIEM enhancements, automate indicator collection, orchestrate response playbooks, and speed up incident reports.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="OPERATIONAL CAPABILITIES" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Contact our SOC optimization consultants to see how adding cognitive automation layers can reduce MTTR and improve threat visibility.
            </motion.p>
          </motion.div>
