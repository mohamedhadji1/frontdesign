...
import { ArrowRight, BrainCircuit, Scale, Lock, ShieldAlert, Cpu, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Aligning your business goals with cybersecurity principles and a phased integration path.",
    icon: BrainCircuit,
  },
  {
    title: "Governance Framework Design",
    description: "Defining clear rules, responsibilities, and accountability across your AI initiatives.",
    icon: Scale,
  },
  {
    title: "Advisory & Trust",
    description: "Navigating the complexities of responsible AI usage, data compliance, and risk mitigation.",
    icon: Lock,
  },
];
...
const capabilities = [
  {
    ...
    description: "Comprehensive auditing of AI models, internal policies, and compliance parameters to detect early-stage structural vulnerabilities.",
    icon: ShieldAlert,
  },
  {
    title: "Strategic Priority",
    description: "Prioritize high-impact AI use cases, establishing precise business and security metrics before initiating development cycles.",
    icon: BrainCircuit,
  },
  {
    title: "Governance & Oversight",
    description: "Formulate clear policies, select key roles, and design validation processes to guarantee accountable and transparent AI usage.",
    icon: Scale,
  },
  {
    title: "Transformation Advisory",
    description: "Partner with executives and business units to drive digital transformation without compromising security standards.",
    icon: Cpu,
  },
];

const offers = [
  "AI & Cybersecurity Strategy Roadmap",
  "AI governance framework design",
  "AI risk and compliance assessment",
  "Responsible AI advisory",
  "AI use case identification and prioritization",
  "Secure AI adoption planning",
  "AI policy and internal guideline development",
  "Executive advisory for AI transformation",
];
        ...
        <div className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center gap-8 px-4 pt-28 pb-40 sm:px-6 sm:pt-32 sm:pb-48 lg:flex-row lg:justify-between lg:gap-0 lg:px-12 lg:pt-24 lg:pb-28 lg:overflow-visible">
          ...
          <div className="flex w-full flex-col items-center gap-4 text-center sm:gap-6 lg:w-2/3 lg:items-start lg:gap-10 lg:text-left">
            ...
            <motion.h2 className="text-3xl font-bold leading-tight tracking-tight text-white max-w-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase">
              <TypingText text="AI Strategy & Governance" delay={0.5} />
            </motion.h2>

            <p className="mt-4 max-w-2xl text-base font-medium tracking-wide text-gray-300 sm:text-lg md:text-xl">
              <TypingText text="Structure a clear, secure, and compliant AI road map aligned with corporate priorities and GRC requirements." delay={2} />
            </p>
            <motion.div
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="Strategy / Framework / Compliance" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center px-4 sm:px-6">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl mb-8 positioning-title uppercase leading-[1.1]">
            AI Strategy & Governance aligns corporate innovation with rigorous risk oversight.
          </h2>
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              Artificial Intelligence is accelerating business processes, yet unstructured implementation creates severe corporate vulnerabilities. Organizations need clear operational principles and policy baselines to keep their AI models secure, compliant, and transparent.
            </p>
            <p>
              Keystone supports enterprises by defining a comprehensive AI & Cybersecurity Strategy Roadmap, designing strong governance structures, and running risk compliance audits to enable confident, resilient AI adoption.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="GOVERNANCE CAPABILITIES" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.h2 className="text-3xl font-black tracking-tight md:text-5xl uppercase leading-[1.1]">
              Align and secure your AI ambition today.
            </motion.h2>
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Get in touch with our security architects to explore how our strategy and governance workshops can guide your secure digital roadmap.
            </motion.p>
          </motion.div>
