        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
              ...
              <span className="text-red-400">AI & Cybersecurity</span>
            </div>
          </motion.div>
          ...
          <HeroTypeLine
            items={["Securing LLMs and Generative AI", "AI-Powered Threat Detection", "Adversarial Machine Learning"]}
          />
 
          <p className="mb-10 text-lg font-light leading-relaxed text-gray-300 md:text-xl lg:text-2xl">
            As Artificial Intelligence transforms businesses, securing AI models from exploitation is paramount. Keystone provides both AI security assessments and AI-driven defense mechanisms to protect your next-generation operations.
          </p>
