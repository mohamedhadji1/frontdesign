...
export function CombinedDeepDive() {
  ...
  const tabs = [
    ...
    { id: "antiphishing", label: "Antiphishing Center", icon: MailWarning },
  ] as const;
    ...
    <div className="w-full relative">
      ...
      <div className="relative z-20 max-w-7xl mx-auto">
        ...
        <p className="text-zinc-600 text-lg md:text-xl leading-relaxed mb-8">
          Explore the core pillars of our advanced defensive tactics. Select a module below to expose our specialized methodologies for Threat Intelligence and Antiphishing.
        </p>
