      ...
      <div className="relative z-20 max-w-7xl mx-auto">
        ...
        >
          <div className="text-center mb-4">
            ...
            <motion.h2 className={`${t.textTitle} font-bold text-sm tracking-widest uppercase mb-4 flex items-center justify-center gap-4`}>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative z-10 flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl font-semibold transition-colors duration-300 w-1/2 sm:w-auto ${isActive
                    ? t.textActive
