...
export const metadata = {
  title: "Implementation CERT | Keystone",
  description: "Comprehensive readiness and cybersecurity implementation services, helping you deploy robust Computer Emergency Response Teams and response capabilities.",
};
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                Implementation <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">CERT</span>
              </h1>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 border border-red-100 text-red-600 mb-4">
               <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
               <span className="text-sm font-medium tracking-wide uppercase">Explore More</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link 
              ...
              className="group block p-8 bg-zinc-50 border border-neutral-200 rounded-2xl hover:border-red-500 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300"
            >
              <Search className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform duration-300" />
            ...
            <Link 
              ...
              className="group block p-8 bg-zinc-50 border border-neutral-200 rounded-2xl hover:border-red-500 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300"
            >
              <Terminal className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform duration-300" />
            ...
            <Link 
              ...
              className="group block p-8 bg-zinc-50 border border-neutral-200 rounded-2xl hover:border-red-500 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300"
            >
              <Siren className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform duration-300" />
            ...
            <Link 
              ...
              className="group block p-8 bg-zinc-50 border border-neutral-200 rounded-2xl hover:border-red-500 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300"
            >
              <ShieldAlert className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform duration-300" />
