...
import { ArrowRight, Database, Lock, EyeOff, ShieldCheck, FileSpreadsheet, Send, FileWarning, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Identify and protect confidential, personal, financial, strategic or regulated information.",
    icon: Database,
  },
  {
    title: "Leakage Prevention",
    description: "Detect and reduce data exfiltration risks through monitored channels and user actions.",
    icon: EyeOff,
  },
  {
    title: "Policy Enforcement",
    description: "Apply rules and controls aligned with business, compliance and data governance requirements.",
    icon: Lock,
  },
];
...
const capabilities = [
  {
    ...
    description: "Automatically identify and tag personal (GDPR/PII), financial, or strategic intellectual property across your systems.",
    icon: FileSpreadsheet,
  },
  {
    title: "Exfiltration Prevention",
    description: "Stop accidental sharing or malicious exfiltration attempts across email, cloud channels, and external storage.",
    icon: Send,
  },
  {
    title: "Compliance Governance",
    description: "Enforce rigorous privacy and data loss policies in compliance with domestic and global data privacy standards.",
    icon: ShieldCheck,
  },
  {
    title: "Incident Tracking Dashboard",
    description: "Review and respond to policy breach warnings, monitor security trends, and audit risk areas in one dashboard.",
    icon: FileWarning,
  },
];
...
const offers = [
  ...
  "Monitoring of risky data movements and leakage attempts",
  "Policy-based data protection and prevention controls",
  "Protection against accidental and intentional data leaks",
  "Dashboards for data protection visibility and incident tracking",
  "Support for compliance and privacy-driven data protection programs"
];

export default function KeystoneDlpPage() {
        ...
        <div className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center gap-8 px-6 pt-36 pb-12 sm:pt-44 lg:flex-row lg:justify-between lg:gap-0 lg:px-12 lg:pt-48 lg:overflow-visible">
          ...
          />
            <motion.h1 className="text-4xl sm:text-5xl md:text-[4.5rem] font-light tracking-tight text-white leading-[1.05] uppercase max-w-5xl">
              <TypingText text="Protect sensitive data against exfiltration and leaks." delay={0.5} />
            </motion.h1>

            <p className="mt-4 max-w-4xl text-base font-medium tracking-wide text-gray-300 sm:text-lg md:text-xl">
              <TypingText text="Keystone DLP structures controls around sensitive information, blocking data loss and ensuring strict policy compliance." delay={2} />
            </p>
            <motion.div
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="Protection / Prevention / Compliance" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              Keystone DLP gives companies the ability to protect sensitive information, reduce exposure to accidental or malicious leakage and strengthen compliance with internal and regulatory data protection requirements.
            </p>
            <p>
              The solution is designed to help organizations gain control over where sensitive data is located, how it is used and how it can leave the organization.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="DLP CAPABILITIES & CONTROLS" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.h2 className="text-3xl font-black tracking-tight md:text-5xl">
              Gain visibility and control over sensitive files.
            </motion.h2>
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Talk to us to see how Keystone DLP fits into your compliance programs and risk governance stack.
            </motion.p>
          </motion.div>
