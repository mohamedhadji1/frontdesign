...
import { ArrowRight, Radar, Globe, UsersRound, ShieldAlert, ShieldCheck, Eye, Cpu, Database, Network, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Monitor threats, indicators, campaigns and adversary activities relevant to your organization.",
    icon: Radar,
  },
  {
    title: "External Attack Surface",
    description: "Discover exposed assets, misconfigurations and internet-facing risks before attackers exploit them.",
    icon: Globe,
  },
  {
    title: "Third-Party Assessment",
    description: "Assess suppliers and partners to identify cyber risks across your extended ecosystem.",
    icon: UsersRound,
  },
];
...
const capabilities = [
  {
    ...
    description: "Real-time feeds and actionable analysis of advanced campaigns, adversaries, and indicators.",
    icon: ShieldAlert,
  },
  {
    title: "Attack Surface Mapping",
    description: "Discover public assets, open services, domain misconfigurations, and external vulnerability exposure.",
    icon: Globe,
  },
  {
    title: "Vendor Risk Assessment",
    description: "Evaluate external partner security, score ecosystem risks, and secure your vendor logistics.",
    icon: Network,
  },
  {
    title: "Actionable Intelligence",
    description: "Interactive executive and analyst dashboards designed for rapid prioritization and threat remediation.",
    icon: Eye,
  },
];

const offers = [
  "Cyber threat intelligence monitoring and reporting",
  "External attack surface discovery and risk scoring",
  "Detection of exposed services, leaked credentials and risky assets",
  "Third-party cybersecurity assessment and vendor risk visibility",
  "Risk dashboards for security teams and executives",
...
export default function KeystoneArenaPage() {
  ...
  useEffect(() => {
    // Dynamic GSAP Loader to prevent Next.js SSR document errors
    Promise.all([
      import("gsap"),
        ...
        <div className="relative z-10 container mx-auto flex flex-1 flex-col items-center justify-center gap-8 px-6 pt-36 pb-12 sm:pt-44 lg:flex-row lg:justify-between lg:gap-0 lg:px-12 lg:pt-48 lg:overflow-visible">
          ...
          <Breadcrumbs
            items={[
              ...
              { label: "Keystone Arena" },
            ]}
            theme="red"
            
          />
            <motion.h1 className="text-4xl sm:text-5xl md:text-[4.5rem] font-light tracking-tight text-white leading-[1.05] uppercase max-w-5xl">
              <TypingText text="Keystone Arena Platform" delay={0.5} />
            </motion.h1>

            <p className="mt-4 max-w-4xl text-base font-medium tracking-wide text-gray-300 sm:text-lg md:text-xl">
              <TypingText text="ARENA structures external threat visibility, anticipating adversary movements and securing third-party risk." delay={2} />
            </p>
            <motion.div
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="CTI / EASM / Third Party Risk" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl mb-8 positioning-title uppercase leading-[1.1]">
            ARENA gives security leaders the visibility they need to understand exposure.
          </h2>
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              ARENA gives security leaders the visibility they need to understand their exposure, anticipate attacks and prioritize remediation. By combining intelligence, external monitoring and third-party assessment, the platform supports a proactive and risk-based cybersecurity posture.
            </p>
            <p>
              It is built for organizations that want to go beyond reactive security and continuously monitor the threats that matter most to their business.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="ARENA CAPABILITIES" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.h2 className="text-3xl font-black tracking-tight md:text-5xl">
              Understand exposure, anticipate attacks.
            </motion.h2>
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Talk to us to see how Keystone ARENA can coordinate threat intelligence and protect your digital perimeter.
            </motion.p>
          </motion.div>
