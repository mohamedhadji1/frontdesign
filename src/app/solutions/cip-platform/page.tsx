...
import { ArrowRight, Server, Landmark, ShieldCheck, Network, Database, Eye, LayoutGrid, type LucideIcon } from "lucide-react";
...
const highlights: HighlightCard[] = [
  {
    ...
    description: "Classify critical information infrastructures by sector, criticality, dependency and risk level.",
    icon: LayoutGrid,
  },
  {
    title: "National Dashboard",
    description: "Centralize indicators and provide a strategic view of critical infrastructure security posture.",
    icon: Landmark,
  },
  {
    title: "Risk Governance",
    description: "Support governance, prioritization and monitoring of protection measures across critical entities.",
    icon: ShieldCheck,
  },
];
...
const capabilities = [
  {
    title: "Sector-Based Mapping",
    description: "Structure visibility across strategic domains (energy, telecoms, government) using standard criticality matrix scoring.",
    icon: Network,
  },
  {
    title: "Maturity Trackers",
    description: "Assess compliance with cyber defense standards, helping organizations audit and report critical infrastructure levels.",
    icon: ShieldCheck,
  },
  {
    title: "Dependency Tracking",
    description: "Map third-party infrastructure linkages and cascading risk factors that impact national resilience.",
    icon: Database,
  },
  {
    title: "Remediation Oversight",
    description: "Coordinate action plans, monitor progress, and provide strategic reporting tools for cybersecurity authorities.",
    icon: Eye,
  },
];

const offers = [
  "Classification of critical information infrastructures",
  "Criticality scoring and sector-based mapping",
  "Centralized national dashboard for critical infrastructure control",
  "Risk, dependency and maturity indicators",
  "Monitoring of remediation plans and security measures",
  "Reporting for authorities, operators and decision-makers"
];

export default function CipPlatformPage() {
      ...
      >
        <div ref={highlightsRef} className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
          <div className="highlights-header mb-12 flex flex-col items-center justify-center">
            ...
            <SectionDivider title="Classification / Governance / Risk" />
          </div>
      ...
      >
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-5xl mb-8 positioning-title uppercase leading-[1.1]">
            Protecting critical infrastructures requires more than isolated controls.
          </h2>
          <div className="text-gray-600 text-base md:text-lg leading-relaxed font-medium space-y-6 positioning-text max-w-4xl mx-auto">
            <p>
              Keystone CIP Platform provides a structured approach to identify what is critical, understand dependencies, monitor risk levels and support decision-making at strategic and operational levels.
            </p>
            <p>
              The platform is designed for national cybersecurity programs, regulators, sectoral authorities and large operators that need a clear and consolidated view of critical digital infrastructures.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col items-center justify-center">
            <CyberSectionDivider className="mb-4" />
            <SectionDivider title="CIP GOVERNANCE & CONTROL" />
          </div>
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <motion.div variants={stagger} className="max-w-3xl">
            ...
            <motion.h2 className="text-3xl font-black tracking-tight md:text-5xl">
              National-level structural risk oversight.
            </motion.h2>
            <motion.p className="mt-5 text-base leading-8 text-zinc-300 md:text-lg">
              Partner with Keystone to deploy a customized critical infrastructure registry and maturity monitoring system.
            </motion.p>
          </motion.div>
