          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            >
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["GDPR", "NIST CSF", "ISO 27001", "National Policy"].map((reg) => (
                    <span
                      key={reg}
            ...
            >
              ...
              <ul className="flex flex-col gap-4">
                {[
                  "Sovereign data confidentiality assured",
                  "Critical national services resilient against state actors",
                  "Incident response team readiness verified"
                ].map((outcome) => (
